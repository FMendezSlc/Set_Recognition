...
def examples(win, path):
    ...
    msg_instructions_0 = visual.TextStim(win, text = 'This is a Set\nPress Spacebar', pos = (0, -5), height = 0.8)
    msg_0.draw()
    card_1.draw()
    card_2.draw()
    card_3.draw()
    ...
    msg_instructions_0 = visual.TextStim(win, text = 'This is also a Set\nPress Spacebar', pos = (0, -5), height = 0.8)
    msg_0.draw()
    card_1.draw()
    card_2.draw()
    card_3.draw()
    ...
    card_2 = visual.ImageStim(win, image = path+'ofbr.png', size = 5, pos = (0, 0))
    card_3 = visual.ImageStim(win, image = path+'oeyd.png', size = 5, pos = (7, 0))
    msg_instructions_0 = visual.TextStim(win, text = 'This is Not a Set\nPress Shift', pos = (0, -5), height = 0.8)
    msg_0.draw()
    card_1.draw()
    card_2.draw()
    card_3.draw()
